    ...
    <div className="flex flex-col gap-6 p-6 bg-white shadow-lg rounded-xl">
      ...
      />
        ...
        <div
          className="mx-auto"
        >
          <Link href={"/forgotPassword"} className="w-full py-2 px-20 mt-2 text-white bg-green-600 hover:bg-green-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-opacity-50">Change Password</Link>
        </div>
      </form>
    </div>
  );
